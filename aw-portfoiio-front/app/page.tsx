...
export default function Home() {
    ...
    const categoryCallouts: Record<string, { title: string; description: React.ReactNode }> = {
        ...
        표준형: {
            ...
            description: (
                <>
                    깔끔하고 정돈된 디자인으로 누구나 쉽게 이용할 수 있는 템플릿입니다.
                    <br />
                    업종과 규모에 구애받지 않고 범용적으로 활용 가능하며, 심플하면서도 전문적인 이미지를 연출하고 싶은 숙소에 적합합니다.
                </>
            ),
        },
        무드형: {
            ...
            description: (
                <>
                    어둡고 차분한 톤의 분위기를 표현하는 템플릿입니다.
                    <br />
                    절제된 디자인으로 풀어낸 감성을 강조하며, 호텔이나 고급 숙소의 품격을 효과적으로 전달합니다.
                </>
            ),
        },
        테마형: {
            ...
            description: (
                <>
                    숙소만의 독특한 컨셉과 개성을 최대한 부각할 수 있는 템플릿입니다.
                    <br />
                    차별화된 구조와 디자인 요소로 숙소의 특별한 스토리와 콘셉트를 고객에게 인상적으로 전달합니다.
                </>
            ),
        },
        유니크: {
            ...
            description: (
                <>
                    일반적이지 않은 독창적인 구조와 눈에 띄는 효과로 강렬한 인상을 남기는 템플릿입니다.
                    <br />
                    남들과 다른 방식으로 숙소를 소개하고 싶거나, 색다른 경험을 제공하고 싶은 숙소에 최적화되어 있습니다.
                </>
            ),
        },
    };
