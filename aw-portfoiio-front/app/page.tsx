...
export default function Home() {
    ...
    const categoryCallouts: Record<string, { title: string; description: React.ReactNode }> = {
        ...
        표준형: {
            title: '표준형 타입',
            description: <>깔끔하고 정돈된 디자인으로 누구나 쉽게 이용할 수 있는 템플릿입니다. 업종과 규모에 구애받지 않고 범용적으로 활용 가능하며, 심플하면서도 전문적인 이미지를 연출하고 싶은 숙소에 적합합니다.</>,
        },
        무드형: {
            title: '무드형 타입',
            description: <>차분하고 세련된 분위기로 고급스러움을 표현하는 템플릿입니다. 어두운 톤과 절제된 디자인으로 프리미엄 감성을 강조하며, 부티크 호텔이나 고급 숙소의 품격을 효과적으로 전달합니다.</>,
        },
        테마형: {
            title: '테마형 타입',
            description: <>숙소만의 독특한 컨셉과 개성을 최대한 부각할 수 있는 템플릿입니다. 차별화된 구조와 디자인 요소로 숙소의 특별한 스토리와 콘셉트를 고객에게 인상적으로 전달합니다.</>,
        },
        유니크: {
            title: '유니크 타입',
            description: <>일반적이지 않은 독창적인 구조와 눈에 띄는 효과로 강렬한 인상을 남기는 템플릿입니다. 남들과 다른 방식으로 숙소를 소개하고 싶거나, 색다른 경험을 제공하고 싶은 숙소에 최적화되어 있습니다.</>,
        },
    };
