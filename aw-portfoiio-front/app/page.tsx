  ...
  return (
    <div className="min-h-screen bg-white">
              ...
              {currentUser && currentUser?.role !== "USER" ? (
                <>
                  ...
                  <button
                    ...
                    className="text-xs md:text-base px-2 md:px-4 py-2 bg-black text-white rounded-lg font-semibold hover:bg-gray-800 transition-all"
                  >
                    관리자 페이지
                  </button>
                  <button
                    onClick={handleClearAuth}
                    className="text-xs md:text-base px-2 md:px-4 py-2 bg-white text-black border-2 border-black rounded-lg font-semibold hover:bg-black hover:text-white transition-all"
                  >
                    로그아웃
                  </button>
                </>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="mb-10 md:mb-18">
          <Swiper
            ...
            loop={true}
            className="w-full rounded-md h-[200px] md:h-[400px] lg:h-[500px]"
          >
            <SwiperSlide>
              <img
                src="/slide1.jpg"
            ...
            {portfolios.map((portfolio) => (
              ...
              >
                ...
                <div className="p-2 pt-6">
                  <h3 className="text-2xl font-bold mb-3 group-hover:text-gray-700">
                    {portfolio.title}
                  </h3>
      ...
      {showPreview && (
        ...
        >
          <div
            className="bg-white rounded-lg shadow-2xl w-full max-w-10xl h-full max-h-[90vh] flex flex-col"
          ...
          >
            ...
            <div className="bg-gray-100 px-4 py-3 rounded-t-lg border-b flex items-center gap-4">
              {/* 주소창 */}
              <div className="flex-1 px-3 py-2 text-sm text-gray-700 overflow-hidden text-ellipsis whitespace-nowrap">
                {previewTitle}
              </div>
              ...
              {isPreviewLoading ? (
                ...
                <div
                  ...
                  style={{
                    ...
                    transform:
                      previewMode === "mobile" ? "scale(1)" : "scale(1)",
                  }}
                >
                  <iframe
